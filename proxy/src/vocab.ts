...
export const EXERCISE_CATALOG: readonly string[] = [
  ...
  "lib_burpee|Burpee|chest",
  "lib_mountain_climbers|Mountain Climbers|core",
  "lib_jumping_jacks|Jumping Jacks|quads",
  "lib_high_knees|High Knees|hip_flexors",
  "lib_jump_rope|Jump Rope|calves",
  "lib_kettlebell_swing|Kettlebell Swing|glutes",
  "lib_box_jump|Box Jump|quads",
  "lib_battle_ropes|Battle Ropes|side_delts",
  "lib_medicine_ball_slam|Medicine Ball Slam|core",
  "lib_wall_ball|Wall Ball|quads",
  "lib_bear_crawl|Bear Crawl|core",
  "lib_renegade_row|Renegade Row|lats",
  "lib_bodyweight_squat|Bodyweight Squat|quads",
  "lib_jump_squat|Jump Squat|quads",
  "lib_bodyweight_lunge|Bodyweight Lunge|quads",
  "lib_bodyweight_split_squat|Bodyweight Split Squat|quads",
  "lib_pistol_squat|Pistol Squat|quads",
  "lib_wall_sit|Wall Sit|quads",
  "lib_bodyweight_calf_raise|Bodyweight Calf Raise|calves",
  "lib_inverted_row|Inverted Row|mid_back",
  "lib_pike_push_up|Pike Push-Up|front_delts",
  "lib_diamond_push_up|Diamond Push-Up|triceps",
  "lib_v_up|V-Up|abs",
  "lib_bicycle_crunch|Bicycle Crunch|obliques",
  "lib_flutter_kicks|Flutter Kicks|hip_flexors",
  "lib_hollow_body_hold|Hollow Body Hold|abs",
  "lib_bird_dog|Bird Dog|core",
  "lib_superman|Superman|lower_back",
  "lib_resistance_band_row|Resistance Band Row|mid_back",
  "lib_resistance_band_pull_apart|Resistance Band Pull-Apart|rear_delts",
];
