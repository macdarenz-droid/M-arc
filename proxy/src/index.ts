...
const askRoute: RouteConfig = {
  ...
  async call(payload, env: WorkerEnv) {
    ...
    return { scope: out.scope, category: out.category, answer: String(out.answer).trim(), splitDrafts: out.splitDrafts, scheduleDraft: out.scheduleDraft, concern: out.concern, constraints: out.constraints, model: out.model, usage: out.usage };
  },
};
