...
export const PALACE: PalaceEntry[] = [
  ...
  // Coach
  e('coach.header', 'Coach', 'Coach tab', 'The coach: what to do next, insights, goal and schedule.', ['coach', 'escobar', 'advice', 'what next'], { tab: 'coach' }),
  e('coach.week-line', 'This week in one line', 'Coach tab → top card', 'This week’s workouts, sets and records in one sentence.', ['week', 'summary', 'one line'], { tab: 'coach' }),
  e('coach.insights', 'Insights', 'Coach tab → Insights', 'Every current coach insight: recovery, progress, readiness, balance, focus. Helpful or Not now on each. A lighter week offer appears above when it’s due.', ['insights', 'notes', 'deload', 'lighter week', 'snooze', 'not now', 'helpful', 'balance'], { tab: 'coach' }, { methods: ['deload_trigger', 'balance', 'plateau'] }),
  e('coach.goal', 'Training goal', 'Coach tab → Training goal', 'Your goal and its rep ranges.', ['goal', 'strength', 'hypertrophy', 'lean', 'muscle', 'fat loss', 'rep range'], { tab: 'coach' }, { methods: ['progression'] }),
  e('panel.goal', 'Change training goal', 'Coach tab → Training goal → Change', 'Pick a goal; it offers the goal’s rest time and templates.', ['change goal', 'switch goal', 'new goal'], { tab: 'coach', panel: 'goal' }),
  e('coach.schedule', 'Weekly schedule', 'Coach tab → Weekly schedule', 'Which split on which weekday. Reminders and streaks follow it.', ['schedule', 'weekly', 'days', 'plan', 'rest days'], { tab: 'coach' }),
  e('panel.schedule', 'Edit the schedule', 'Coach tab → Weekly schedule → Edit', 'Assign a split or rest to each day, or quick-arrange 2–6 days.', ['edit schedule', 'move day', 'change days', 'arrange'], { tab: 'coach', panel: 'schedule' }),
  e('panel.weekly-review', 'Weekly review', 'Coach tab → Weekly review card', 'What stood out this week, good or bad. Shown after 5+ training days in a week.', ['weekly review', 'review', 'recap', 'week summary'], { tab: 'coach', panel: 'weekly-review' }, { methods: ['weekly_review'] }),
  e('coach.tip', 'Coach tip', 'Coach tab → Coach tip / Worth knowing', 'A technique cue or fact about your last exercise. Tap Another for more.', ['tip', 'cue', 'technique', 'form', 'learn'], { tab: 'coach' }),
  e('coach.sees', 'What the coach can see', 'Coach tab → What the coach can see', 'What data the coach has, and what adding more would unlock.', ['data', 'what coach sees', 'unlock', 'privacy'], { tab: 'coach' }, { methods: ['fidelity'] }),
  e('coach.thinks', 'How the coach thinks', 'Coach tab → How the coach thinks', 'Plain rules: reps first then load, when to step down, recovery thresholds.', ['how', 'rules', 'logic', 'method', 'explain'], { tab: 'coach' }, { methods: ['progression', 'recovery'] }),
