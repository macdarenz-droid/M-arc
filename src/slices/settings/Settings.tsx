    ...
    <Sheet title="Settings" onClose={onClose}>
      <div class="stack">
        ...
        <Section title="Coach online">
          <Card class="stack-sm">
            <Row trailing={<Toggle checked={s.coach.remoteExplainer} onChange={v => setCoach({ remoteExplainer: v })} label="Online coach" />}><span class="small">Online coach</span><div class="hint">Off by default. When on, your own proxy and Claude help with a few things: fuller wording when you tap "More from the coach", answers when you ask it a question, suggested equipment and muscles when you tap "Suggest" or "Scan a photo" on a new exercise, and tags for a session note (never a diagnosis). Each request sends only what that one thing needs, never your sessions, name or measurements; a photo you scan is sent once for that suggestion and never saved. A fraction of a cent a time.</div></Row>
