  ...
  return (
    <div class="view">
      <div class="topbar">
        ...
        <div class="row">
          {remoteEnabled.value && moment && <Button variant="quiet" size="sm" onClick={openAsk} aria-label={`Ask ${COACH_NAME}`}><IconMafia size={16} aria-hidden={true} /> {COACH_NAME}</Button>}
  ...
  return (
    <div class="view">
      ...
      */}
      ...
      {heartRateSurfacesVisible.value && <HeartRateCard />}
...
function FinishScreen({ summary, onClose }: { summary: FinishSummary; onClose: () => void }) {
  ...
  return (
    <div class="view">
      ...
      {heartRateSurfacesVisible.value && <SessionHeartRate session={session} />}
