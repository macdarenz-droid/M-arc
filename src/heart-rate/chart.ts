...
/**
 * Points for a trace, with an explicit break wherever the signal was missing
 * or the contact flag failed. The line is never drawn straight through a gap:
 * a reading that was not taken must not look like one that was.
 */
