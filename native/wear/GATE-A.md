...
- A tiny watch diagnostic page: sensor bpm, status, Stop HR and swipe counter. Source overlay for an official **Lite Wearable JS** DevEco template; not an independently validated HAP.
...
6. Build/sign/install that HAP with the official tool. Open it on the GT6. Photograph its “M/ARC · GATE A” screen. In the phone lab enter this watch bundle/fingerprint and tap Register watch receiver.
