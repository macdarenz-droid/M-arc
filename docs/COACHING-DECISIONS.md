...
- **Balance (BR-17):** counted per exercise set, split across its primary buckets. Upper is the **mean** of push and pull, so 4 bench + 4 row + 4 squat reads balanced (the finding's own test; summing push and pull flagged every full-body week).
